...
const productController = {
    ...
    productDetail: (req,res) => {                                                 // ACA se pone el callback que sacamos de ROUTES. Este será el encargado de generar la respuesta.
        ...
        res.render('productDetail', {product: product})                           // Le envía a ESTA view las variables dinámicas que necesita.  // ESTE ES UN .EJS (modificar los .html a .ejs). Es NECESARIO setear el VIEW ENGINE en app.js para usar res.render(). // Le envía a ESTA view las variables dinámicas que necesita.
    }
}
